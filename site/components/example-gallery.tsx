...
const themeScroll = {
  intervalMs: 5000,
  file: 'vgpu.ts',
  values: shaderSettings.map(settings => applyShaderSettings(shaderFiles['vgpu.ts'], settings)),
}

const shaderAction = { label: 'Shuffle setting', generate: shuffleShaderSettings, playback: false }
